<!--FOOTER  Partner Logo Section Begin -->
<section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
    <div class="container py-4">
      <div class="row d-flex justify-content-center py-5">
        <div class="col-md-6">
            <h2 style="font-size: 22px;" class="mb-0">S'abonner à la Newsletter</h2>
            <span>Obtenez des mises à jour de nos promotions et meilleurs deals</span>
        </div>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              <li><a href={{URL('/accueil')}} class="py-2 d-block">Magasin</a></li>
              <li><a href="#" class="py-2 d-block">About</a></li>
              <li><a href="#" class="py-2 d-block">Journal</a></li>
              <li><a href={{URL('/accueil')}} class="py-2 d-block">Nous joindre</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
